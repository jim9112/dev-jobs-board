...
const MasterHeader = ({ outerDiv }: CompProps) => {
  ...
  return (
    <header className="bg-header-mobile lg:bg-header-desktop md:bg-header-tablet bg-cover bg-no-repeat h-40 py-8 md:py-10 lg:py-11 px-6 md:px-9 lg:px-20 xl:px-40 2xl:px-80">
